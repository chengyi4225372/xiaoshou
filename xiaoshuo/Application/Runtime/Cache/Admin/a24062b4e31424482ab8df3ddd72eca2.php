	...
	<div class="col-xs-12">
		<div class="box">
			<div class="box-header">
				...
				<a href="<?php echo U('Mch/edit2');?>" class="btn btn-success">添加代理商</a>
				<div class="box-tools">
					<form class="form-inline" method="post">
						<div class="form-group">
							<div class="input-group input-group-md" style="width: 150px;">
								<input type="text" name="title" class="form-control pull-right" placeholder="代理商名称" value="<?php echo ($_GET['title']); ?>">
				...
				<table class="table table-bordered table-hover table-striped text-center">
					<tbody>
						...
						<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
								...
								<td><?php echo ($v['lv']/100); ?></td>
								<td><?php echo ((isset($v["zcharge"]) && ($v["zcharge"] !== ""))?($v["zcharge"]):"0.00"); ?></td>
								<td><?php echo ((isset($v["jcharge"]) && ($v["jcharge"] !== ""))?($v["jcharge"]):"0.00"); ?></td>
								<td><?php echo ((isset($v["allcharge"]) && ($v["allcharge"] !== ""))?($v["allcharge"]):"0.00"); ?></td>
								<td>
									<div>
								...
								<td>
									<a href="<?php echo U('edit2',array('id'=>$v['id']));?>" class="btn btn-info">
										<i class="fa fa-edit"></i>修改
									</a>
									<a href="javascript:;" onclick="deleteAmTables('mch',<?php echo ($v["id"]); ?>)" class="cannel_vip btn bg-maroon margin">
