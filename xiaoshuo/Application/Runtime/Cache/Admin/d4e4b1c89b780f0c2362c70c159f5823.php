...
<section class="content row" style="padding-top: 20px">
	<div class="col-sm-3">
		<div class="content-box">
			<div class="content-box-header">
				<div class="left">
					<label class="moban-type">模版1<input style="margin-left: 5px;" type="radio" value="1" name="choose" <?php if($tpl == 1): ?>checked="checked"<?php endif; ?>></label>
				</div>
			</div>
			<div class="content-box-body">
				<div class="show-container">
					<div class="show">
						<img src="/Public/admin/images/mub1.jpg" style="width: 100%">
					</div>
				</div>
			</div>
		</div>
	...
	<div class="col-sm-3">
		<div class="content-box">
			<div class="content-box-header">
				<div class="left">
					<label class="moban-type">模版2<input style="margin-left: 5px;" type="radio" value="2" name="choose" <?php if($tpl == 2): ?>checked="checked"<?php endif; ?>></label>
				</div>
			</div>
			<div class="content-box-body">
				<div class="show-container">
					<div class="show">
						<img src="/Public/admin/images/mub2.jpg" style="width: 100%">
					</div>
				</div>
			</div>
		</div>
		...
		<div class="content-box">
			<div class="content-box-header">
				<div class="left">
					<label class="moban-type">模版3<input style="margin-left: 5px;" type="radio" value="3" name="choose" <?php if($tpl == 3): ?>checked="checked"<?php endif; ?>></label>
				</div>
			</div>
			<div class="content-box-body">
				<div class="show-container">
					<div class="show">
						<img src="/Public/admin/images/mub3.jpg" style="width: 100%;height: 378px;">
					</div>
				</div>
			</div>
		</div>
	...
	<div class="col-sm-3">
		<div class="content-box">
			<div class="content-box-header">
				<div class="left">
					<label class="moban-type">模版4<input style="margin-left: 5px;" type="radio" value="4" name="choose" <?php if($tpl == 4): ?>checked="checked"<?php endif; ?>></label>
				</div>
			</div>
			<div class="content-box-body">
				<div class="show-container">
					<div class="show">
						<img src="/Public/admin/images/mub4.jpg" style="width: 100%;height: 378px;">
					</div>
				</div>
			</div>
		</div>
...
<script>
	$('.moban-type').on('click', function () {
		var tpl = $("input[name='choose']:checked").val();
		$.post("<?php echo U('tpl');?>",{tpl:tpl},function(d){
			if(d){
