				...
				<table class="table table-bordered table-striped table-hover">
					...
					<tr>
						<th colspan="8">
							<form class="form-inline" method="post">
								...
								<span>-</span>
								<div class="input-group input-group-sm">
								<input type="text" name="time2" class="form-control reservationtime" placeholder="结束时间" value="<?php echo ($_GET['time2']); ?>">
								</div>
								<div class="input-group input-group-sm">
									<input type="submit" value="确定查找" class="btn btn-sm btn-success">
								</div>
							</form>
						</th>
					</tr>
					...
					<tbody>
						<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
							...
							<td >
								<span><?php echo ($v["smoney"]); ?></span>
							</td>
							<td>
								<span><?php echo ($v["lv"]); ?></span>
							</td>
							<td >
								<span><?php echo ($v['mch']['title']); ?></span>
							</td>
							<td>
								<span>
									<?php if($v['isyear'] == 1): ?>是
