		...
		<div class="col-xs-12">
			<div class="box">
				<div class="box-header with-border">
					<a href="<?php echo U('edit');?>" class="btn btn-success">添加活动</a>
				</div>
				<div class="box-body">
						...
						<tbody>
							...
							<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
								...
								<td style="width: 150px;">
									<?php echo (date("Y-m-d H:i:s",$v["stime"])); ?>
									<br>
									<?php echo (date("Y-m-d H:i:s",$v["etime"])); ?>
								</td>
								<td>充<?php echo ($v["money"]); ?>送<?php echo ($v["smoney"]); ?></td>
								<td>
									<?php if($nowtime < $v['etime']): ?><p>
											<img src="/Public/images/fire.png" width="20" height="20">
											<i style="color:red">活动火热进行中 ！！！</i>
										</p>
										http://<?php echo ($_site['url']); ?>/index.php?a=activity&id=<?php echo ($v["id"]); ?>
										<button type="button" class="btn btn-primary copy" data-clipboard-action="copy" data-clipboard-text="http://<?php echo ($_site['url']); ?>/index.php?a=activity&id=<?php echo ($v["id"]); ?>">复制</button>																													</td>
									<?php else: ?>
										请点击获取链接按钮获取<?php endif; ?>
								</td>
								<td>￥<?php echo ($v["charge_total"]); ?></td>
								<td><?php echo ($v["charge_nums"]); ?></td>
								<td>
									<div class="switch switch-small checkbox has-switch" data-title="is_push" data-on="success" onclick="clickCheckbox(<?php echo ($v["id"]); ?>,this,'isshow');">
										<div class="switch-animate <?php if($v['isshow'] == 1): ?>switch-on<?php else: ?>switch-off<?php endif; ?>">
								...
								<td>
									<div class="switch switch-small checkbox has-switch" data-title="is_push" data-on="success" onclick="clickCheckbox(<?php echo ($v["id"]); ?>,this,'status');">
								...
								<td>
									<a href="<?php echo U('edit',array('id'=>$v['id']));?>" class="btn btn-info">
										<i class="fa fa-edit"></i>修改
									</a>
									<a href="javascript:;" onclick="deleteAmTables('activity',<?php echo ($v["id"]); ?>)" class="cannel_vip btn bg-maroon margin">
...
<script>
	function clickCheckbox(id,ob,field){
		$.post("<?php echo U('setFieldStatus');?>",{id:id,field:field},function(d){
			if(d){
