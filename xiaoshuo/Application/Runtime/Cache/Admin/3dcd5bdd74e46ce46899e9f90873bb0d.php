...
<div class="row" id="member-summary-stats-panel">
	<div class="col-md-3">
		<div class="well">
			...
			<div class="text-primary" style="font-size:32px;margin:5px 0">
				<span><?php echo ((isset($tuser['all']) && ($tuser['all'] !== ""))?($tuser['all']):"0"); ?>人</span>
				<div style="font-size:13px;" class="text-muted">
					<b class="text-warning"><?php echo ((isset($tuser['nuser']) && ($tuser['nuser'] !== ""))?($tuser['nuser']):"0"); ?>人</b> 男性,
					<b class="text-warning"><?php echo ((isset($tuser['vuser']) && ($tuser['vuser'] !== ""))?($tuser['vuser']):"0"); ?>人</b> 女性,
					<b class="text-warning" title="用户未设置性别或未关注而无法获取性别"><?php echo ((isset($tuser['wuser']) && ($tuser['wuser'] !== ""))?($tuser['wuser']):"0"); ?></b>
					未知
				</div>
			</div>
			<div>
				...
				<span><?php echo ((isset($tuser['subuser']) && ($tuser['subuser'] !== ""))?($tuser['subuser']):"0"); ?>人</span>
				(<span><?php echo sprintf("%0.2f",$tuser['subuser']/$tuser['all']*100);?></span>%)
				</b>
			</div>
			<div>
				已付费:
				<b class="text-warning">
				<span><?php echo ((isset($tuser['payuser']) && ($tuser['payuser'] !== ""))?($tuser['payuser']):"0"); ?>人</span>
				(<span><?php echo sprintf("%0.2f",$tuser['payuser']/$tuser['all']*100);?></span>%)
				</b>
			</div>
		</div>
	</div>
	<div class="col-md-3">
		<div class="well">
			<b>昨日新增</b>
			<div class="text-primary" style="font-size:32px;margin:5px 0">
				<span><?php echo ((isset($yuser['all']) && ($yuser['all'] !== ""))?($yuser['all']):"0"); ?>人</span>
				<div style="font-size:13px;" class="text-muted">
					<b class="text-warning"><?php echo ((isset($yuser['nuser']) && ($yuser['nuser'] !== ""))?($yuser['nuser']):"0"); ?>人</b> 男性,
					<b class="text-warning"><?php echo ((isset($yuser['vuser']) && ($yuser['vuser'] !== ""))?($yuser['vuser']):"0"); ?>人</b> 女性,
					<b class="text-warning" title="用户未设置性别或未关注而无法获取性别"><?php echo ((isset($yuser['wuser']) && ($yuser['wuser'] !== ""))?($yuser['wuser']):"0"); ?></b>
					未知
				</div>
			</div>
			<div>
				已关注:
				<b class="text-warning">
				<span><?php echo ((isset($yuser['subuser']) && ($yuser['subuser'] !== ""))?($yuser['subuser']):"0"); ?>人</span>
				(<span><?php echo sprintf("%0.2f",$yuser['subuser']/$yuser['all']*100);?></span>%)
				</b>
			</div>
			<div>
				已付费:
				<b class="text-warning">
				<span><?php echo ((isset($yuser['payuser']) && ($yuser['payuser'] !== ""))?($yuser['payuser']):"0"); ?>人</span>
				(<span><?php echo sprintf("%0.2f",$yuser['payuser']/$yuser['all']*100);?></span>%)
				</b>
			</div>
		</div>
	</div>
	<div class="col-md-3">
		<div class="well">
			...
			<div class="text-primary" style="font-size:32px;margin:5px 0">
				<span><?php echo ((isset($muser['all']) && ($muser['all'] !== ""))?($muser['all']):"0"); ?>人</span>
				<div style="font-size:13px;" class="text-muted">
					<b class="text-warning"><?php echo ((isset($muser['nuser']) && ($muser['nuser'] !== ""))?($muser['nuser']):"0"); ?>人</b> 男性,
					<b class="text-warning"><?php echo ((isset($muser['vuser']) && ($muser['vuser'] !== ""))?($muser['vuser']):"0"); ?>人</b> 女性,
					<b class="text-warning" title="用户未设置性别或未关注而无法获取性别"><?php echo ((isset($muser['wuser']) && ($muser['wuser'] !== ""))?($muser['wuser']):"0"); ?></b>
					未知
				</div>
			</div>
			<div>
				已关注:
				<b class="text-warning">
				<span><?php echo ((isset($muser['subuser']) && ($muser['subuser'] !== ""))?($muser['subuser']):"0"); ?>人</span>
				(<span><?php echo sprintf("%0.2f",$muser['subuser']/$muser['all']*100);?></span>%)
				</b>
			</div>
			<div>
				已付费:
				<b class="text-warning">
				<span><?php echo ((isset($muser['payuser']) && ($muser['payuser'] !== ""))?($muser['payuser']):"0"); ?>人</span>
				(<span><?php echo sprintf("%0.2f",$muser['payuser']/$muser['all']*100);?></span>%)
				</b>
			</div>
		</div>
	</div>
	<div class="col-md-3">
		<div class="well">
			...
			<div class="text-primary" style="font-size:32px;margin:5px 0">
				<span><?php echo ((isset($auser['all']) && ($auser['all'] !== ""))?($auser['all']):"0"); ?>人</span>
				<div style="font-size:13px;" class="text-muted">
					<b class="text-warning"><?php echo ((isset($auser['nuser']) && ($auser['nuser'] !== ""))?($auser['nuser']):"0"); ?>人</b> 男性,
					<b class="text-warning"><?php echo ((isset($auser['vuser']) && ($auser['vuser'] !== ""))?($auser['vuser']):"0"); ?>人</b> 女性,
					<b class="text-warning" title="用户未设置性别或未关注而无法获取性别"><?php echo ((isset($auser['wuser']) && ($auser['wuser'] !== ""))?($auser['wuser']):"0"); ?></b>
					未知
				</div>
			</div>
			<div>
				已关注:
				<b class="text-warning">
				<span><?php echo ((isset($auser['subuser']) && ($auser['subuser'] !== ""))?($auser['subuser']):"0"); ?>人</span>
				(<span><?php echo sprintf("%0.2f",$auser['subuser']/$auser['all']*100);?></span>%)
				</b>
			</div>
			<div>
				已付费:
				<b class="text-warning">
				<span><?php echo ((isset($auser['payuser']) && ($auser['payuser'] !== ""))?($auser['payuser']):"0"); ?>人</span>
				(<span><?php echo sprintf("%0.2f",$auser['payuser']/$auser['all']*100);?></span>%)
				</b>
			</div>
		</div>
	</div>
				...
				<table class="table table-bordered table-hover table-striped">
					<tbody>
						...
						<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
							...
							<td><?php echo ceil($v['joinpersonpay']*$v['joinperson']/100);?></td>
							<td><?php echo ($v["sexaperson"]); ?></td>
							<td><?php echo ($v["sexvperson"]); ?></td>
