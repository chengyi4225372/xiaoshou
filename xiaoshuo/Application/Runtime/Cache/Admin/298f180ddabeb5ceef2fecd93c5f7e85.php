...
<section class="content">
				...
				<div class="col-md-4">
					<div class="panel panel-success">
						...
						<div class="panel-body">
							<h5>充值总额：<strong><?php echo ((isset($tops['zcharge']) && ($tops['zcharge'] !== ""))?($tops['zcharge']):"0.00"); ?></strong>元</h5>
							<h5>充值笔数：<strong><?php echo ((isset($tops['zchargeNums']) && ($tops['zchargeNums'] !== ""))?($tops['zchargeNums']):"0"); ?></strong>笔</h5>
						</div>
					</div>
				</div>
				<div class="col-md-4">
					<div class="panel panel-info">
						...
						<div class="panel-body">
							<h5>充值总额：<strong><?php echo ((isset($tops['dcharge']) && ($tops['dcharge'] !== ""))?($tops['dcharge']):"0.00"); ?></strong>元</h5>
							<h5>充值笔数：<strong><?php echo ((isset($tops['dchargeNums']) && ($tops['dchargeNums'] !== ""))?($tops['dchargeNums']):"0"); ?></strong>笔</h5>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="form-group" style="float: left;margin: 8px;">
				<ul class="nav nav-pills channelType" style="margin-bottom: 10px;">
					<li class="dbtype" data-btype="1">
						<a class="btn novelrecharge_btn" href="<?php echo U('charge',array('btype'=>1));?>" data-toggle="tabs">漫画充值统计</a>
					</li>
					<li class="dbtype" data-btype="2">
						<a class="btn commendbook_btn" href="<?php echo U('charge',array('btype'=>2));?>" data-toggle="tabs">小说充值统计</a>
					</li>
				</ul>
			</div>
		</div>
	...
	<script>
		$(function(){
			var btype = "<?php echo ($_GET['btype']); ?>"?"<?php echo ($_GET['btype']); ?>":1;
					...
					<div class="box-tools" style="left: 10px;top: 10px">
						<form class="form-inline" method="post">
							<div class="input-group input-group-sm" style="width: 200px;">
								<input type="text" name="title" class="form-control pull-right" placeholder="名称" value="<?php echo ($_GET['title']); ?>">
						...
						<form style="margin-left:230px;margin-top:-30px;" method="post" id="form">
							<div class="input-group input-group-sm">
								<select id="order" name="order" style="width:120px;" class="form-control" onchange="Confirm();" default="<?php echo ($_GET['order']); ?>">
					...
					<table class="table table-striped table-hover table-bordered text-center">
						<tbody>
							...
							<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
								...
								<td><?php echo ((isset($v["chapterNums"]) && ($v["chapterNums"] !== ""))?($v["chapterNums"]):"0"); ?></td>
								<td><?php echo ((isset($v["tcharge"]) && ($v["tcharge"] !== ""))?($v["tcharge"]):"0"); ?></td>
								<td><?php echo ((isset($v["ycharge"]) && ($v["ycharge"] !== ""))?($v["ycharge"]):"0"); ?></td>
								<td><?php echo ((isset($v["acharge"]) && ($v["acharge"] !== ""))?($v["acharge"]):"0"); ?></td>
