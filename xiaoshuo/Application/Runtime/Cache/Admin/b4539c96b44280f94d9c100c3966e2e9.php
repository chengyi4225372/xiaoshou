				...
				<div class="box-header">
					<form class="form-inline" action="" method="post" style="display: inline-block;">
						<div class="input-group input-group-sm">
							<input type="text" name="user_id" class="form-control" value="<?php echo ($_GET['user_id']); ?>" placeholder="请输入用户ID">
						</div>
						<div class="input-group input-group-sm">
							<input type="text" name="time1" value="<?php echo ($_GET['time1']); ?>" class="form-control reservationtime" placeholder="开始时间">
						</div>
						<span>-</span>
						<div class="input-group input-group-sm">
							<input type="text" name="time2" value="<?php echo ($_GET['time2']); ?>" class="form-control reservationtime" placeholder="结束时间">
						</div>
						<div class="input-group input-group-sm">
							<input type="submit" value="搜索" class="btn btn-sm btn-success">
						</div>
					</form>
				</div>
				<!-- /.box-header -->
