		...
		<div class="box">
			...
			<div class="box-body">
				<table class="table table-bordered table-hover table-striped">
					...
					<tr>
						<td>漫画首页</td>
						<td>http://<?php echo ($_site['url']); ?>/index.php?m=&c=Index&a=index</td>
						<td><button class="btn btn-sm btn-success copy" data-clipboard-action="copy" data-clipboard-text="http://<?php echo ($_site['url']); ?>/index.php?m=&c=Index&a=index">点击复制</button></td>
					</tr>	
					<tr>
						<td>小说首页</td>
						<td>http://<?php echo ($_site['url']); ?>/index.php?m=&c=Index&a=novel</td>
						<td><button class="btn btn-sm btn-success copy" data-clipboard-action="copy" data-clipboard-text="http://<?php echo ($_site['url']); ?>/index.php?m=&c=Index&a=novel">点击复制</button></td>
					</tr>
					<tr>
						<td>个人中心</td>
						<td>http://<?php echo ($_site['url']); ?>/index.php?m=&c=Index&a=my</td>
						<td><button class="btn btn-sm btn-success copy" data-clipboard-action="copy" data-clipboard-text="http://<?php echo ($_site['url']); ?>/index.php?m=&c=Index&a=my">点击复制</button></td>
					</tr>
					<tr>
						<td>充值</td>
						<td>http://<?php echo ($_site['url']); ?>/index.php?m=&c=Index&a=charge</td>
						<td><button class="btn btn-sm btn-success copy" data-clipboard-action="copy" data-clipboard-text="http://<?php echo ($_site['url']); ?>/index.php?m=&c=Index&a=charge">点击复制</button></td>
					</tr>
					<tr>
						<td>账单明细</td>
						<td>http://<?php echo ($_site['url']); ?>/index.php?m=&c=Index&a=report</td>
						<td><button class="btn btn-sm btn-success copy" data-clipboard-action="copy" data-clipboard-text="http://<?php echo ($_site['url']); ?>/index.php?m=&c=Index&a=report">点击复制</button></td>
					</tr>
					<tr>
						<td>书签</td>
						<td>http://<?php echo ($_site['url']); ?>/index.php?m=&c=Index&a=collectHistory</td>
						<td><button class="btn btn-sm btn-success copy" data-clipboard-action="copy" data-clipboard-text="http://<?php echo ($_site['url']); ?>/index.php?m=&c=Index&a=collectHistory">点击复制</button></td>
					</tr>
					<tr>
						<td>历史记录</td>
						<td>http://<?php echo ($_site['url']); ?>/index.php?m=&c=Index&a=readHistory</td>
						<td><button class="btn btn-sm btn-success copy" data-clipboard-action="copy" data-clipboard-text="http://<?php echo ($_site['url']); ?>/index.php?m=&c=Index&a=readHistory">点击复制</button></td>
					</tr>
					<tr>
						<td>漫画排行榜</td>
						<td>http://<?php echo ($_site['url']); ?>/index.php?m=&c=Index&a=rank&btype=1</td>
						<td><button class="btn btn-sm btn-success copy" data-clipboard-action="copy" data-clipboard-text="http://<?php echo ($_site['url']); ?>/index.php?m=&c=Index&a=rank&btype=1">点击复制</button></td>
					</tr>
					<tr>
						<td>小说排行榜</td>
						<td>http://<?php echo ($_site['url']); ?>/index.php?m=&c=Index&a=rank&btype=2</td>
						<td><button class="btn btn-sm btn-success copy" data-clipboard-action="copy" data-clipboard-text="http://<?php echo ($_site['url']); ?>/index.php?m=&c=Index&a=rank&btype=2">点击复制</button></td>
					</tr>
					<tr>
						<td>漫画免费</td>
						<td>http://<?php echo ($_site['url']); ?>/index.php?m=&c=Index&a=moreList&field=isfw&value=2&btype=1</td>
						<td><button class="btn btn-sm btn-success copy" data-clipboard-action="copy" data-clipboard-text="http://<?php echo ($_site['url']); ?>/index.php?m=&c=Index&a=moreList&field=isfw&value=2&btype=1">点击复制</button></td>
					</tr>
					<tr>
						<td>小说免费</td>
						<td>http://<?php echo ($_site['url']); ?>/index.php?m=&c=Index&a=moreList&field=isfw&value=2&btype=2</td>
						<td><button class="btn btn-sm btn-success copy" data-clipboard-action="copy" data-clipboard-text="http://<?php echo ($_site['url']); ?>/index.php?m=&c=Index&a=moreList&field=isfw&value=2&btype=2">点击复制</button></td>
					</tr>
					<tr>
						<td>漫画分类</td>
						<td>http://<?php echo ($_site['url']); ?>/index.php?m=&c=Index&a=bookType&btype=1</td>
						<td><button class="btn btn-sm btn-success copy" data-clipboard-action="copy" data-clipboard-text="http://<?php echo ($_site['url']); ?>/index.php?m=&c=Index&a=bookType&btype=1">点击复制</button></td>
					</tr>
					<tr>
						<td>小说分类</td>
						<td>http://<?php echo ($_site['url']); ?>/index.php?m=&c=Index&a=bookType&btype=2</td>
						<td><button class="btn btn-sm btn-success copy" data-clipboard-action="copy" data-clipboard-text="http://<?php echo ($_site['url']); ?>/index.php?m=&c=Index&a=bookType&btype=2">点击复制</button></td>
					</tr>
					</tbody>
				</table>
			</div>
