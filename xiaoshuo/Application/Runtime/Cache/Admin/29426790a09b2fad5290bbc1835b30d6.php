	...
	<div class="col-xs-12">
		<div class="box">
			<div class="box-header">
				...
				<a href="<?php echo U('Config/middleedit');?>" class="btn btn-success">添加导航</a>
				<div class="box-tools">
					<form class="form-inline" method="post">
						<div class="form-group">
							<div class="input-group input-group-md" style="width: 300px;">
								<input type="text" name="title" class="form-control pull-right" placeholder="标题名称" value="<?php echo ($_GET['title']); ?>">
				...
				<table class="table table-bordered table-hover table-striped text-center">
					<tbody>
						...
						<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
								...
								<td style="text-align:left"><?php echo ($v["url"]); ?></td>
								<td><?php echo (date("Y-m-d H:i:s",$v["create_time"])); ?></td>
								<td>
									<a href="<?php echo U('middleedit',array('id'=>$v['id']));?>" class="btn btn-info">
										<i class="fa fa-edit"></i>修改
									</a>
									<a href="javascript:;" onclick="deleteAmTables('middle',<?php echo ($v["id"]); ?>)" class="cannel_vip btn bg-maroon margin">
