				...
				<form class="form-horizontal" style="margin-top:30px" method="POST" action="" enctype="multipart/form-data">
					<div class="box-body">
						...
						<div class="form-group">
							<label for="name" class="control-label col-sm-3">图标</label>
							<div class="col-sm-6">
								<iframe src="<?php echo U('Index/upload', 'event=setPics&url='.$_logo['img']);?>" scrolling="no" style="width:100px;height:100px;border: none;display:block;"></iframe>
								<input type="hidden" name="img" id="img" value="<?php echo ($_logo['img']); ?>" class="smallinput" />
								<script>
