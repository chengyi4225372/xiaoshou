				...
				<table class="table table-bordered table-hover table-striped text-center">
					<tbody>
						...
						<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
								<td><img src="<?php echo ($v["coverpic"]); ?>" width="50" height="70"></td>
								<td><?php echo ($v["title"]); ?></td>
								<td><?php echo ($v["nickname"]); ?></td>
								<td><img src="<?php echo ($v["headimg"]); ?>" width="50" height="50" style="border-radius:50%;"></td>
								...
								<td>
									<a href="javascript:;" onclick="deleteAmTables('comments',<?php echo ($v["id"]); ?>)" class="cannel_vip btn bg-maroon margin">
...
<script>
	function clickCheckbox(id,ob){
		$.post("<?php echo U('setCommentsStatus');?>",{id:id},function(d){
			if(d){
