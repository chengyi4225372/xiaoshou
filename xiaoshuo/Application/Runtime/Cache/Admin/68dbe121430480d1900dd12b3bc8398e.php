...
.vstore input{width:90%!important;float:left;}
.vstore i{width:10%;font-size:30px;float:left;cursor:pointer}
</style>
	...
	<div class="col-xs-12">
		<div class="box box-primary">
			<div class="box-header">
				<a href="javascript:;" onclick="add();" class="btn btn-success" style="float:left; margin-right:15px;">添加分类</a>
			</div>
			<!-- /.box-header -->
			<form class="form-horizontal" style="margin-top:30px" method="POST" action="" enctype="multipart/form-data">
				<div class="box-body" id="list">
					<?php if(!$_xsStore): ?><div id="nolist">暂时没有分类信息，请添加！</div>
					<?php else: ?>
						<?php if(is_array($_xsStore)): foreach($_xsStore as $key=>$v): ?><span class="vstore">
								<input name="list[]" class="form-control col-sm-3" value="<?php echo ($v); ?>" />
								<i class="fa fa-times" onclick="delThis(this)"></i>
							</span><?php endforeach; endif; endif; ?>
				</div>
				<!-- /.box-body -->
				<div class="box-footer" id="btn" <?php if(!$_xsStore): ?>style="display:none"<?php endif; ?>>
...
<script>
	function add(){
		...
		var html = '<span class="vstore"><input name="list[]" class="form-control col-sm-3" /><i class="fa fa-times" onclick="delThis(this)"></i></span>';
