				...
				<table class="table table-bordered table-hover table-striped text-center">
					<tbody>
						...
						<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
								<td><?php echo ($v["nickname"]); ?>(<?php echo ($v["user_id"]); ?>)</td>
								<td><img src="<?php echo ($v["coverpic"]); ?>" style="width:35px;height:35px;margin-right:10px;" /><?php echo ($v["atitle"]); ?></td>
