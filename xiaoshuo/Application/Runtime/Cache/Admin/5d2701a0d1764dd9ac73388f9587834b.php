	...
	<div class="col-xs-12">
		<div class="box">
			<div class="box-header">
				...
				<a href="<?php echo U('Config/navedit');?>" class="btn btn-success">添加导航</a>
				<div class="box-tools">
				...
				<table class="table table-bordered table-hover table-striped text-center">
					<tbody>
						...
						<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
								...
								<td>
									<a href="<?php echo U('navedit',array('id'=>$v['id']));?>" class="btn btn-info">
										<i class="fa fa-edit"></i>修改
									</a>
									<a href="javascript:;" onclick="deleteAmTables('nav',<?php echo ($v["id"]); ?>)" class="cannel_vip btn bg-maroon margin">
