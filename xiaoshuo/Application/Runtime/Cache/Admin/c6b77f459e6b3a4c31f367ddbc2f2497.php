	...
	<div class="col-xs-12">
		<div class="box">
			<div class="box-header">
				...
				<a href="javascript:;" onclick="addTr();" class="btn btn-success">添加轮播</a>
			</div>
			<!-- /.box-header -->
			<div class="box-body">
				<form class="form-horizontal" style="margin-top:30px" method="POST" enctype="multipart/form-data">
					<table class="table table-bordered table-hover table-striped text-center">
						<tbody id="tables">
							...
							<?php if(is_array($_xsBanner)): foreach($_xsBanner as $key=>$v): ?><tr>
									<td><input type="text" name="pic[]" class="form-control col-sm-9" value="<?php echo ($v["pic"]); ?>"></td>
...
<script>
	function addTr(){
		var html = '';
			html='<tr><td>';
			html+='<input type="text" name="pic[]" class="form-control col-sm-9" value="">';
			html+='</td><td>';
