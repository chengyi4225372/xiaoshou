	...
	<div class="col-xs-12">
		<div class="box">
			<div class="box-header">
				...
				<a href="<?php echo U('Mch/edit');?>" class="btn btn-success">添加渠道商</a>
				<div class="box-tools">
					<form class="form-inline" method="post">
						<div class="form-group">
							<div class="input-group input-group-md" style="width: 150px;">
								<input type="text" name="title" class="form-control pull-right" placeholder="渠道商名称" value="<?php echo ($_GET['title']); ?>">
