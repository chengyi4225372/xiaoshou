	...
	<div class="col-xs-12">
		<div class="box box-primary">
			<div class="box-header">
				<a href="javascript:;" onclick="add();" class="btn btn-success" style="float:left; margin-right:15px;">添加区域</a>
			</div>
			<!-- /.box-header -->
			<form class="form-horizontal" style="margin-top:30px" method="POST" action="" enctype="multipart/form-data">
				<div class="box-body" id="list">
					<?php if(!$_xsArea): ?><div id="nolist">暂时没有区域信息，请添加！</div>
					<?php else: ?>
						<?php if(is_array($_xsArea)): foreach($_xsArea as $key=>$v): ?><span class="vstore">
				...
				<!-- /.box-body -->
				<div class="box-footer" id="btn" <?php if(!$_xsArea): ?>style="display:none"<?php endif; ?>>
