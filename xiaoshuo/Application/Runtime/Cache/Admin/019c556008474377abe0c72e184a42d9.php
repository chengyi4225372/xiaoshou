	...
	<div class="col-xs-12">
		<div class="box">
			<div class="box-header">
				...
				<a href="<?php echo U('edit');?>" class="btn btn-success">添加关键词</a>
			</div>
			<!-- /.box-header -->
			<div class="box-body">
				<table class="table table-bordered table-hover table-striped text-center">
					<tbody>
						...
						<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
								...
								<td>
									<?php if($v['type'] == 2): ?><a href="<?php echo U('News/index',array('aid'=>$v['id']));?>" class="cannel_vip btn bg-olive margin">
											<i class="fa fa-image"></i>&nbsp;管理图文
										</a><?php endif; ?>
									<a href="<?php echo U('edit',array('id'=>$v['id']));?>" class="btn btn-info">
										<i class="fa fa-edit"></i>修改
									</a>
									<a href="javascript:;" onclick="deleteAmTables('autoreply',<?php echo ($v["id"]); ?>)" class="cannel_vip btn bg-maroon margin">
