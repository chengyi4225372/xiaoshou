...
<div>
	<ol class="breadcrumb" style="background: none; margin-bottom: 0px;">
		...
		<li class="active">充值信息</li>
		<li class="active">充值设置</li>
	</ol>
</div>
</section>
	...
	<div class="col-xs-12">
		<div class="box">
			<div class="box-header">
				...
				<a href="javascript:;" onclick="addTr();" class="btn btn-success">添加充值</a>
			</div>
			<!-- /.box-header -->
			<div class="box-body">
				<form class="form-horizontal" style="margin-top:30px" method="POST" enctype="multipart/form-data">
					<table class="table table-bordered table-hover table-striped text-center">
						<tbody id="tables">
							...
							<?php if(is_array($_charge)): foreach($_charge as $key=>$v): ?><tr>
									<td><input type="text" name="money[]" class="form-control col-sm-9" value="<?php echo ($v["money"]); ?>"></td>
									<td><input type="text" name="smoney[]" class="form-control col-sm-9" value="<?php echo ($v["smoney"]); ?>"></td>
									<td><input type="text" name="lv[]" class="form-control col-sm-9" value="<?php echo ($v["lv"]); ?>"></td>
									<td>
										<select class="form-control col-sm-9" name="ishot[]" default="<?php echo ($v['ishot']); ?>">
									...
									<td>
										<select class="form-control col-sm-9" name="ishalf[]" default="<?php echo ($v['ishalf']); ?>">
											<option value="">请选择</option>
											<option value="1">是</option>
											<option value="0">否</option>
										</select>
									...
									<td>
										<select class="form-control col-sm-9" name="isyear[]" default="<?php echo ($v['isyear']); ?>">
											<option value="">请选择</option>
											<option value="1">是</option>
											<option value="0">否</option>
										</select>
									...
									<td>
										<select class="form-control col-sm-9" name="isover[]" default="<?php echo ($v['isover']); ?>">
											<option value="">请选择</option>
											<option value="1">是</option>
											<option value="0">否</option>
										</select>
									...
									<td>
										<select class="form-control col-sm-9" name="isopen[]" default="<?php echo ($v['isopen']); ?>">
											<option value="">请选择</option>
											<option value="1">是</option>
											<option value="0">否</option>
										</select>
									...
									<td>
										<select class="form-control col-sm-9" name="ischoose[]" default="<?php echo ($v['ischoose']); ?>">
											<option value="">请选择</option>
											<option value="1">是</option>
											<option value="0">否</option>
										</select>
...
<script>
	function addTr(){
		var html = '';
			...
			html+='<td>';
			html+='<input type="text" name="smoney[]" class="form-control col-sm-9" value="">';
			html+='</td>';
			
			html+='<td>';
			html+='<input type="text" name="lv[]" class="form-control col-sm-9" value="">';
			html+='</td>';
			
			html+='<td>';
			html+='<select class="form-control col-sm-9" name="ishot[]" default="">';
			...
			html+='<td>';
			html+='<select class="form-control col-sm-9" name="ishalf[]" default="">';
			html+='<option value="">请选择</option>';
			html+='<option value="1">是</option>';
			html+='<option value="0">否</option>';
			html+='</select>';
			...
			html+='<td>';
			html+='<select class="form-control col-sm-9" name="isyear[]" default="">';
			html+='<option value="">请选择</option>';
			html+='<option value="1">是</option>';
			html+='<option value="0">否</option>';
			html+='</select>';
			...
			html+='<td>';
			html+='<select class="form-control col-sm-9" name="isover[]" default="">';
			html+='<option value="">请选择</option>';
			html+='<option value="1">是</option>';
			html+='<option value="0">否</option>';
			html+='</select>';
			...
			html+='<td>';
			html+='<select class="form-control col-sm-9" name="isopen[]" default="">';
			html+='<option value="">请选择</option>';
			html+='<option value="1">是</option>';
			html+='<option value="0">否</option>';
			html+='</select>';
			...
			html+='<td>';
			html+='<select class="form-control col-sm-9" name="ischoose[]" default="">';
			html+='<option value="">请选择</option>';
			html+='<option value="1">是</option>';
			html+='<option value="0">否</option>';
			html+='</select>';
