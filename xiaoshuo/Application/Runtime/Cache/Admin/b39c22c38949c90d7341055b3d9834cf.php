			...
			<div class="box-header">
				...
				<div style="float: left;margin-left: 10px">
					<form method="post" class="clearfix">
						<div class="input-group input-group-sm" style="float: left;margin-left: 5px">
							<select class="select-get-attention" name="btype" style="height: 30px;" default="<?php echo ($_GET['btype']); ?>">
						...
						<div class="input-group input-group-sm" style="width: 200px;float: left;margin-left: 5px">
							<input type="text" name="title" class="form-control" value="<?php echo ($_GET['title']); ?>" id="title" style="width: 200px" placeholder="书名">
						</div>
				...
				<table class="table table-bordered table-hover table-striped text-center">
					<tbody>
						...
						<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
							...
							<td><?php echo ($v["seqing"]); ?></td>
							<td><?php echo ($v["xuexing"]); ?></td>
							<td><?php echo ($v["baoli"]); ?></td>
							<td><?php echo ($v["weifa"]); ?></td>
							<td><?php echo ($v["daoban"]); ?></td>
							<td><?php echo ($v["qita"]); ?></td>
							<td><?php echo ($v["nums"]); ?></td>
							<td>
								<a href="javascript:;" onclick="deleteAmTables('lodge',<?php echo ($v["id"]); ?>)" class="cannel_vip btn bg-maroon margin">
