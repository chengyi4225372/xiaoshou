...
<section class="content">
	<div class="row">
				...
				<form class="form-horizontal" style="margin-top:30px" method="POST" action="" enctype="multipart/form-data">
					<div class="box-body">
						<div class="form-group">
							<label for="name" class="control-label col-sm-3">登录用户名</label>
							<div class="col-sm-6">
								<input type="text" name="name" class="form-control col-sm-9" value="<?php echo ($_user['name']); ?>">
								<p class="help-block help-block-error col-sm-7 col-xs-10"></p>
							</div>
						</div>

						<div class="form-group">
							<label for="pass" class="control-label col-sm-3">登录密码</label>
							<div class="col-sm-6">
								<input type="password" name="pass" class="form-control col-sm-9" value="">
								<p class="help-block help-block-error col-sm-7 col-xs-10"></p>
							</div>
						</div>
						
						<div class="form-group">
							<label for="pass" class="control-label col-sm-3">确认密码</label>
							<div class="col-sm-6">
								<input type="password" name="tpass" class="form-control col-sm-9" value="">
								<p class="help-block help-block-error col-sm-7 col-xs-10"></p>
							</div>
						</div>
	    ...
	    <script type="text/javascript" src="/Public/home/js/jqey-3.3.js"></script>
		</div><!-- /.col -->
	</div>
</section>
