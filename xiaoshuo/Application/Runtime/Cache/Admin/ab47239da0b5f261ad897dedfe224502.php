				...
				<form class="form-horizontal" style="margin-top:30px" method="POST" action="" enctype="multipart/form-data">
					<div class="box-body">
						<div class="form-group">
							<label for="name" class="control-label col-sm-3">服务号视频地址</label>
							<div class="col-sm-6">
								<input type="text" name="furl" class="form-control col-sm-9" value="<?php echo ($_camera['furl']); ?>">
								<p class="help-block help-block-error col-sm-7 col-xs-10"></p>
							</div>
						</div>

						<div class="form-group">
							<label for="name" class="control-label col-sm-3">订阅号视频地址</label>
							<div class="col-sm-6">
								<input type="text" name="durl" class="form-control col-sm-9" value="<?php echo ($_camera['durl']); ?>">
								<p class="help-block help-block-error col-sm-7 col-xs-10"></p>
							</div>
						</div>
					</div>
