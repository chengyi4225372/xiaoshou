	...
	<div class="col-xs-12">
		<div class="box">
			<div class="box-header">
				...
				<a href="<?php echo U('Notice/edit');?>" class="btn btn-success">添加公告</a>
				<div class="box-tools">
					...
					<tbody>
						...
						<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
								...
								<td>
									...
									<a href="javascript:;" onclick="deleteAmTables('notice',<?php echo ($v["id"]); ?>)" class="cannel_vip btn bg-maroon margin">
